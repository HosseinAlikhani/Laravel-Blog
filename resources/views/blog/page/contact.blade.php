...
@section('css')
<link rel="stylesheet" type="text/css" href="{{ asset('theme/styles/contact.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('theme/styles/contact_responsive.css') }}">
@endsection

@section('content')
    <div class="home">
        <div class="home_background parallax-window" data-parallax="scroll" data-image-src="{{ asset('theme/images/regular.jpg') }}" data-speed="0.8"></div>
