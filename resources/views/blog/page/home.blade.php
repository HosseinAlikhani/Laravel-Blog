                    ...
                    <div class="header_content d-flex flex-row align-items-center justify-content-start">
                        ...
                        <div class="search_container ml-auto">
                            <div class="weather">
                                ...
                                <img class="weather_icon" src="{{ asset('theme/images/cloud.png') }}" alt="">
                            </div>
                            <form action="#">
                                <input type="search" class="header_search_input" required="required" placeholder="Type to Search...">
                                <img class="header_search_icon" src="{{ asset('theme/images/search.png') }}" alt="">
                            </form>
    ...
    <div class="home">
        ...
        <div class="home_slider_container">
            <div class="owl-carousel owl-theme home_slider">
                ...
                <!-- Slider Item -->
                <div class="owl-item">
                    <div class="home_slider_background" style="background-image:url( {{ asset('theme/images/home_slider.jpg') }})"></div>
                    ...
                    <div class="similar_posts_container">
                        ...
                        <div class="home_slider_next_container">
                            <div class="home_slider_next" style="background-image:url({{ asset('theme/images/home_slider_next.jpg') }})">
...
{{--                                        <img class="card-img-top" src="{{ asset('theme/images/post_1.jpg') }}" alt="https://unsplash.com/@cjtagupa">--}}
{{--                                        <div class="card-body">--}}
...
{{--                                        <div class="card_background" style="background-image:url( {{ asset('theme/images/post_4.jpg') }})"></div>--}}
{{--                                        <div class="card-body">--}}
{{--                                            <div class="card-title card-title-small"><a href="post.html">How Did van Gogh’s Turbulent Mind Depict One of the Most Complex Concepts in Physics?</a></div>--}}
{{--                                            <small class="post_meta"><a href="#">Katy Liu</a><span>Sep 29, 2017 at 9:48 am</span></small>--}}
{{--                                        </div>--}}
...
{{--                                        <img class="card-img-top" src=" {{ asset('theme/images/post_2.jpg') }}" alt="https://unsplash.com/@jakobowens1">--}}
{{--                                        <div class="card-body">--}}
{{--                                            <div class="card-title card-title-small"><a href="post.html">How Did van Gogh’s Turbulent Mind Depict One of the Most Complex Concepts in Physics?</a></div>--}}
{{--                                            <small class="post_meta"><a href="#">Katy Liu</a><span>Sep 29, 2017 at 9:48 am</span></small>--}}
{{--                                        </div>--}}
...
{{--                                    <!-- Small Card With Image -->--}}
{{--                                    <div class="card card_small_with_image grid-item">--}}
{{--                                        <img class="card-img-top" src="{{ asset('theme/images/post_3.jpg') }}" alt="https://unsplash.com/@jannerboy62">--}}
{{--                                        <div class="card-body">--}}
{{--                                            <div class="card-title card-title-small"><a href="post.html">How Did van Gogh’s Turbulent Mind Depict One of the Most Complex Concepts in Physics?</a></div>--}}
{{--                                            <small class="post_meta"><a href="#">Katy Liu</a><span>Sep 29, 2017 at 9:48 am</span></small>--}}
{{--                                        </div>--}}
...
{{--                                        <img class="card-img-top" src="{{ asset('theme/images/post_9.jpg') }}" alt="">--}}
{{--                                        <div class="card-body">--}}
{{--                                            <div class="card-title"><a href="post.html">How Did van Gogh’s Turbulent Mind Depict One of the Most Complex Concepts in Physics?</a></div>--}}
{{--                                            <p class="card-text">Pick the yellow peach that looks like a sunset with its red, orange, and pink coat skin, peel it off with your teeth. Sink them into unripened...</p>--}}
{{--                                            <small class="post_meta"><a href="#">Katy Liu</a><span>Sep 29, 2017 at 9:48 am</span></small>--}}
...
{{--                                    <div class="card card_small_with_image grid-item">--}}
{{--                                        <img class="card-img-top" src="{{ asset('theme/images/post_5.jpg') }}" alt="">--}}
{{--                                        <div class="card-body">--}}
{{--                                            <div class="card-title card-title-small"><a href="post.html">How Did van Gogh’s Turbulent Mind Depict One of the Most Complex Concepts in Physics?</a></div>--}}
{{--                                            <small class="post_meta"><a href="#">Katy Liu</a><span>Sep 29, 2017 at 9:48 am</span></small>--}}
{{--                                        </div>--}}
...
{{--                                                        <div class="video_image"><div><img src="{{ asset('theme/images/video_1.jpg') }}" alt=""></div><img class="play_img" src="images/play.png" alt=""></div>--}}
...
{{--                                                    <div class="video d-flex flex-row align-items-center justify-content-start">--}}
{{--                                                        <div class="video_image"><div><img src="{{ asset('theme/images/video_2.jpg') }}" alt=""></div><img class="play_img" src="images/play.png" alt=""></div>--}}
{{--                                                        <div class="video_content">--}}
{{--                                                            <div class="video_title">How Did van Gogh’s Turbulent Mind</div>--}}
{{--                                                            <div class="video_info"><span>1.2M views</span><span>Sep 29</span></div>--}}
{{--                                                        </div>--}}
...
{{--                                                    <div class="video d-flex flex-row align-items-center justify-content-start">--}}
{{--                                                        <div class="video_image"><div><img src="{{ asset('theme/images/video_3.jpg') }}" alt=""></div><img class="play_img" src="images/play.png" alt=""></div>--}}
{{--                                                        <div class="video_content">--}}
{{--                                                            <div class="video_title">How Did van Gogh’s Turbulent Mind</div>--}}
{{--                                                            <div class="video_info"><span>1.2M views</span><span>Sep 29</span></div>--}}
{{--                                                        </div>--}}
...
{{--                                                    <div class="video d-flex flex-row align-items-center justify-content-start">--}}
{{--                                                        <div class="video_image"><div><img src="{{ asset('theme/images/video_4.jpg') }}" alt=""></div><img class="play_img" src="images/play.png" alt=""></div>--}}
{{--                                                        <div class="video_content">--}}
{{--                                                            <div class="video_title">How Did van Gogh’s Turbulent Mind</div>--}}
{{--                                                            <div class="video_info"><span>1.2M views</span><span>Sep 29</span></div>--}}
{{--                                                        </div>--}}
                    ...
                    <div class="sidebar">
                                    ...
                                    <div class="owl-carousel owl-theme sidebar_slider_top">
                                        ...
                                        <div class="owl-item">
                                            ...
                                            <div class="side_post">
                                                <a href="post.html">
                                                    <div class="d-flex flex-row align-items-xl-center align-items-start justify-content-start">
                                                        <div class="side_post_image"><div><img src="{{ asset('theme/images/top_1.jpg') }}" alt=""></div></div>
                                            ...
                                            <div class="side_post">
                                                <a href="post.html">
                                                    <div class="d-flex flex-row align-items-xl-center align-items-start justify-content-start">
                                                        <div class="side_post_image"><div><img src="{{ asset('theme/images/top_2.jpg') }}" alt=""></div></div>
                                                        <div class="side_post_content">
                                                            <div class="side_post_title">How Did van Gogh’s Turbulent Mind</div>
                                                            <small class="post_meta">Katy Liu<span>Sep 29</span></small>
                                                        </div>
                                            ...
                                            <div class="side_post">
                                                <a href="post.html">
                                                    <div class="d-flex flex-row align-items-xl-center align-items-start justify-content-start">
                                                        <div class="side_post_image"><div><img src="{{ asset('theme/images/top_3.jpg') }}" alt=""></div></div>
                                                        <div class="side_post_content">
                                                            <div class="side_post_title">How Did van Gogh’s Turbulent Mind</div>
                                                            <small class="post_meta">Katy Liu<span>Sep 29</span></small>
                                                        </div>
                                            ...
                                            <div class="side_post">
                                                <a href="post.html">
                                                    <div class="d-flex flex-row align-items-xl-center align-items-start justify-content-start">
                                                        <div class="side_post_image"><div><img src="{{ asset('theme/images/top_4.jpg') }}" alt=""></div></div>
                                                        <div class="side_post_content">
                                                            <div class="side_post_title">How Did van Gogh’s Turbulent Mind</div>
                                                            <small class="post_meta">Katy Liu<span>Sep 29</span></small>
                                                        </div>
                        ...
                        <div class="sidebar_section">
                            <div class="advertising">
                                <div class="advertising_background" style="background-image:url({{ asset('theme/images/post_17.jpg') }})"></div>
