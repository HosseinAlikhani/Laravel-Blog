...
<link rel="stylesheet" type="text/css" href=" {{ asset('theme/plugins/jquery.mb.YTPlayer-3.1.12/jquery.mb.YTPlayer.css') }}">
    ...
    <div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
        ...
        <div class="search">
            <form action="#">
                ...
                <img class="header_search_icon menu_mm" src="{{ asset('theme/images/search_2.png') }}" alt="">
            </form>
        </div>
        <nav class="menu_nav">
            <ul class="menu_mm">
