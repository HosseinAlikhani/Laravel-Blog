...
<html lang="en">
  <head>
    ...
    <!-- plugins:css -->
    <link rel="stylesheet" href="{{ asset('panel/assets/vendors/iconfonts/mdi/css/materialdesignicons.css') }}">
    <!-- endinject -->
    <!-- vendor css for this page -->
    <!-- End vendor css for this page -->
    <!-- inject:css -->
    <link rel="stylesheet" href="{{ asset('panel/assets/css/shared/style.css') }}">
    <!-- endinject -->
    <!-- Layout style -->
    <link rel="stylesheet" href="{{ asset('panel/assets/css/demo_1/style.css') }}">
    <!-- Layout style -->
    <link rel="shortcut icon" href="{{ asset('panel/asssets/images/favicon.ico') }}" />
  </head>
  <body class="header-fixed">
    ...
    <nav class="t-header">
      <div class="t-header-brand-wrapper">
        <a href="index.html">
          <img class="logo" src="{{ asset('panel/assets/images/logo.svg') }}" alt="">
          <img class="logo-mini" src="{{ asset('panel/assets/images/logo_mini.svg') }}" alt="">
        </a>
      </div>
                ...
                <div class="dropdown-body">
                  <div class="dropdown-list">
                    <div class="image-wrapper">
                      <img class="profile-img" src="{{ asset('panel/assets/images/profile/male/image_1.png') }}" alt="profile image">
                  ...
                  <div class="dropdown-list">
                    <div class="image-wrapper">
                      <img class="profile-img" src="{{ asset('panel/assets/images/profile/female/image_2.png') }}" alt="profile image">
                      <div class="status-indicator rounded-indicator bg-success"></div>
                    </div>
                    <div class="content-wrapper">
                  ...
                  <div class="dropdown-list">
                    <div class="image-wrapper">
                      <img class="profile-img" src="{{ asset('panel/assets/images/profile/male/image_3.png') }}" alt="profile image">
      ...
      <div class="sidebar">
        <div class="user-profile">
          <div class="display-avatar animated-avatar">
            <img class="profile-img img-lg rounded-circle" src="{{asset('panel/assets/images/profile/male/image_1.png')}}" alt="profile image">
          </div>
                    ...
                    <div class="wrapper">
                      <div class="d-flex justify-content-between">
                        <div class="split-header">
                          <img class="img-ss mt-1 mb-1 mr-2" src="{{ asset('panel/assets/images/social-icons/instagram.svg') }}" alt="instagram">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover table-sm">
                      ...
                      <tbody>
                        <tr>
                          <td class="pr-0 pl-4">
                            <img class="profile-img img-sm" src="{{ asset('panel/assets/images/profile/male/image_4.png') }}" alt="profile image">
                          </td>
                          <td class="pl-md-0">
                        ...
                        <tr>
                          <td class="pr-0 pl-4">
                            <img class="profile-img img-sm" src="{{ asset('panel/assets/images/profile/male/image_3.png') }}" alt="profile image">
                          </td>
                          <td class="pl-md-0">
                        ...
                        <tr>
                          <td class="pr-0 pl-4">
                            <img class="profile-img img-sm" src="{{ asset('panel/assets/images/profile/female/image_2.png') }}" alt="profile image">
                          </td>
                          <td class="pl-md-0">
                        ...
                        <tr>
                          <td class="pr-0 pl-4">
                            <img class="profile-img img-sm" src="{{ asset('panel/assets/images/profile/male/image_10.png') }}" alt="profile image">
                          </td>
                          <td class="pl-md-0">
                      ...
                      <div class="timeline-vertical dashboard-timeline">
                        ...
                        <div class="activity-log">
                          ...
                          <div class="log-details">Report has been updated <div class="grouped-images mt-2">
                              <img class="img-sm" src="{{ asset('panel/assets/images/profile/male/image_4.png') }}" alt="Profile Image" data-toggle="tooltip" title="Gerald Pierce">
                              <img class="img-sm" src="{{ asset('panel/assets/images/profile/male/image_5.png') }}" alt="Profile Image" data-toggle="tooltip" title="Edward Wilson">
                              <img class="img-sm" src="{{ asset('panel/assets/images/profile/female/image_6.png') }}" alt="Profile Image" data-toggle="tooltip" title="Billy Williams">
                              <img class="img-sm" src="{{ asset('panel/assets/images/profile/male/image_6.png') }}" alt="Profile Image" data-toggle="tooltip" title="Lelia Hampton">
    ...
    <!-- plugins:js -->
    <script src="{{ asset('panel/assets/vendors/js/core.js') }}"></script>
    <!-- endinject -->
    <!-- Vendor Js For This Page Ends-->
    <script src="{{ asset('panel/assets/vendors/apexcharts/apexcharts.min.js') }}"></script>
    <script src="{{ asset('panel/assets/vendors/chartjs/Chart.min.js') }}"></script>
    <script src="{{ asset('panel/assets/js/charts/chartjs.addon.js') }}"></script>
    <!-- Vendor Js For This Page Ends-->
    <!-- build:js -->
    <script src="{{ asset('panel/assets/js/template.js') }}"></script>
