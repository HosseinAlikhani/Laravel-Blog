                ...
                <div>
                    ...
                    <div class="row portfolio">
                        <div class="col-sm-6 custom-pad-1">
                            <img src="{{ asset('devblog/images/portfolio/1.jpg') }}" class="img-responsive" alt="">
                        </div>
                    ...
                    <div class="row portfolio">
                        <div class="col-sm-6 custom-pad-1">
                            <div class="image-carousel">
                                <img src="{{ asset('devblog/images/portfolio/2.jpg') }}" class="img-responsive" alt="">
                                <img src="{{ asset('devblog/images/portfolio/3.jpg') }}" class="img-responsive" alt="">
                            </div>
                        </div>
                    ...
                    <div class="row portfolio">
                        <div class="col-sm-6 custom-pad-1">
                            <img src="{{ asset('devblog/images/portfolio/4.jpg') }}" class="img-responsive" alt="">
                        </div>
                    ...
                    <div class="row portfolio">
                        <div class="col-sm-6 custom-pad-1">
                            <img src="{{ asset('devblog/images/portfolio/6.jpg') }}" class="img-responsive" alt="">
                        </div>
