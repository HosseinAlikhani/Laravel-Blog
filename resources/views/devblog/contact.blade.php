                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="testimonial-client-info">
                            ...
                            <div class="testimonial-client client-thumb">
                                <img src="{{ asset('devblog/images/testimonial/1.png') }}" alt="">
                            </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="testimonial-client-info">
                            ...
                            <div class="testimonial-client client-thumb">
                                <img src="{{ asset('devblog/images/testimonial/2.png') }}" alt="">
                            </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="testimonial-client-info">
                            ...
                            <div class="testimonial-client client-thumb">
                                <img src="{{ asset('devblog/images/testimonial/3.png') }}" alt="">
                            </div>
